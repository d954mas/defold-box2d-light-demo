...
local function json_haxe_clear(data)
	data.__fields__ = nil
...
function M.json_haxe(data_haxe,pretty)
	local data = M.encode(json_haxe_clear(LUME.clone_deep(data_haxe)))
	if pretty then data = M.pretty(data) end
	return data
end
